...
export default function HeroBackground() {
  return (
    <motion.div
      ...
      animate="visible"
      aria-hidden="true"
      className="relative hidden lg:flex lg:h-[560px] lg:items-center lg:justify-center"
    >
      {/* Glow backdrop */}
      <div className="absolute inset-0 -right-12">
        <div className="absolute left-1/2 top-1/2 h-[400px] w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[var(--primary)]/[0.08] blur-[100px]" />
        <div className="absolute left-1/3 top-1/3 h-[250px] w-[250px] rounded-full bg-[var(--primary)]/[0.04] blur-[80px]" />
      </div>
      ...
      >
        <div className="rounded-3xl border border-[var(--glass-border)] bg-[var(--glass)] p-8 shadow-[var(--shadow-xl)] backdrop-blur-2xl">
          {/* Header */}
          <div className="mb-6 flex items-center gap-3">
            <div className="flex size-10 items-center justify-center rounded-2xl bg-gradient-to-br from-[var(--primary)] to-rose-600 shadow-lg shadow-[var(--primary)]/25">
          ...
          <div className="grid grid-cols-3 gap-3">
            {techStack.map((tech) => (
              <motion.div
                ...
                transition={spring}
                className="group flex flex-col items-center gap-2 rounded-2xl border border-[var(--glass-border)] bg-[var(--surface-overlay)] p-3 transition-all duration-300 hover:border-[var(--glass-border-hover)] hover:shadow-[var(--shadow-md)]"
              >
                <div
          ...
          {/* Stats bar */}
          <div className="mt-6 grid grid-cols-3 gap-3 border-t border-[var(--glass-border)] pt-5">
            {[
              { value: "3+", label: "Years" },
